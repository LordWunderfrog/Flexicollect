/*
* ClientResponsesAndReport component. 
* This component will render Responses and Reporting menu for Client User.
*  
*/
...
export class ClientResponsesAndReport extends Component {
  openReportApp = e => {
...
export default withStyles(styles)(ClientResponsesAndReport);